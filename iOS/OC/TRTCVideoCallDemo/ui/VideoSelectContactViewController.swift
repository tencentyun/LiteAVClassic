//
//  VideoSelectContactViewController.swift
//  trtcScenesDemo
//
...
class VideoSelectContactViewController: UIViewController, TRTCVideoCallDelegate {
    ...
    lazy var selectTable: UITableView = {
        ...
        table.register(VideoSelectUserTableViewCell.classForCoder(), forCellReuseIdentifier: "VideoSelectUserTableViewCell")
        table.delegate = self
    ...
    lazy var userPanel: UICollectionView = {
        ...
        panel.register(VideoSelectUserCollectionViewCell.classForCoder(), forCellWithReuseIdentifier: "VideoSelectUserCollectionViewCell")
