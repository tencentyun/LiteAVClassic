...
extension AudioSelectContactViewController {
    func setupUI() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(hiddenNoMembersImg), name: NSNotification.Name("HiddenNoSearchAudioNotificationKey"), object: nil)
    ...
    func showSelectVC() {
        self.selectedFinished = { [weak self] users in
            ...
            TRTCAudioCall.shared().groupCall(userIds, groupID: nil)
        }
    }
